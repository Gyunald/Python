...
if 'start' not in st.session_state:
    st.session_state.start = dt_time(8,0)

if 'end' not in st.session_state:
    st.session_state.end = dt_time(20,20)
...
with c2:
    start_time = st.time_input('시작 시간', st.session_state.start, step=600)
    end_time = st.time_input('종료 시간', st.session_state.end, step=600)
